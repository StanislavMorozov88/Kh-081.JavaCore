...
public class Person {
    ...
    public void changeName(String fn, String ln) {
        if (fn.length() > 2) {
            System.out.println("Ur name's length should be more than 2 symbols, " +
                    "otherwise we will use your previous name");
            this.firstName = fn;
        }
        if (ln.length() > 2) {
            System.out.println("Ur surname's length should be more than 2 symbols, " +
                    "otherwise we will use your previous surname");
            this.lastName = ln;
        }
    }
